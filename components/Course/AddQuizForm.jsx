...
const AddQuizForm = ({ course, setCourse, setAddQuizOpen }) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (data.success === true) {
                ...
                setLoading(false);
                toast.warning("Couldn't create lesson");
            }
        } catch (err) {
                    ...
                    <div className="w-full">
                        ...
                        <div className="quiz my-4">
                            <p className="font-semibold text-lg">
                                Question {questionIndex + 1}/{value.length}
                            </p>
                            <div>
                                <div className="my-4 flex justify-start">
                                    <input
                                        onChange={handleQues}
                                        className="w-full mr-4 px-2 border-2 outline-none rounded-md border-black text-lg"
                                        value={value[questionIndex].question}
